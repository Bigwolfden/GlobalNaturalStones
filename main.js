...
function runCustEdit(){
  ...
  win.extra.loadURL(`file://${__dirname}/pages/customerEdit.html`);
	
}

function runNewCust(){
	win.extra.loadURL(`file://${__dirname}/pages/addClient.html`);
}
...
function createClientViewer({user, tokens}) {
  win.main.loadURL(`file://${__dirname}/pages/main.html`);
