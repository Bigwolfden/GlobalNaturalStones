...
let myNotification = new Notification('Title', {
  ...
  myNotification.onclick = () => {
	...
	$("#ClientList").on("click", ".btnEditInfo", function(e) {
		...
		//Add the gray texture over top of the main window to prevent the user from altering it while the edit menu is open
...
****************************************/
	...
	//Filters the list of clients displayed to the user
